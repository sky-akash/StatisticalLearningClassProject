...
###### Here, the goal was to check if digits 3 & 6, or 1 and 9 could be well distinguished by the machine learning algorithms. However, I found that the algorithm was able to clearly distinguish between these digits, but not able to distinguish between the digits 2, 3 and 5 (clusters 1 and 4) upto a large extent. Further, there is some overlap between the digits 0 and 7 as well (in cluster 10).
